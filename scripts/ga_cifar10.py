...
def save_csv(history, after_acc, after_loss):
    ...
    csv_path = ('./output/ga_cifar_noaug_variGAdata_3conv_128_BPseed42_GAseed44_500.csv')
...
def main():
    ...
    # BPの学習済みモデルを読み込む
    load_path = './output/binaryconnect_cifar_noaug_variGAdata_3conv_128_seed42_500.pt'
   ...
   # GA進化用45,000枚の画像番号
    ...
    plt.tight_layout()
    plt.savefig('./output/ga_cifar_noaug_variGAdata_3conv_128_BPseed42_GAseed44_500.png')
    plt.close()
